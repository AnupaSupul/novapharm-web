...
const Footer = () => {
  return (
    <footer className="footer">
      {/* Desktop Version - Standard 4-column */}
      ...
      {/* Mobile Version - Simple Centered */}
      <div className="footer__mobile">
        <ScrollReveal>
          <div className="container footer-simple__inner">
            <div className="footer-simple__content">
              <img src="/logo.png" alt="NovaPharm" className="footer-simple__logo" />
              ...
              <p className="footer-simple__copyright">
                &copy; {new Date().getFullYear()} NovaPharm. All rights reserved.
              </p>
              ...
              <div className="footer-simple__social">
                ...
                <a href="#" className="social-pill" aria-label="Instagram">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5" /><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" /></svg>
                </a>
