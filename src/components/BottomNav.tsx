...
const BottomNav = () => {
  return (
    <div className="bottom-nav mobile-view">
      <div className="bottom-nav__inner">
        ...
        <NavLink to="/about" className={({ isActive }) => `bottom-nav__item ${isActive ? 'active' : ''}`}>
        ...
        <NavLink to="/products" className={({ isActive }) => `bottom-nav__item ${isActive ? 'active' : ''}`}>
        ...
        <NavLink to="/contact" className={({ isActive }) => `bottom-nav__item ${isActive ? 'active' : ''}`}>
